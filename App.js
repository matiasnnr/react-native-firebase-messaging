...
const App = () => {
  ...
  const showNotification = (channelId, options) => {
    PushNotification.localNotification({
      ...
      bigLargeIconUrl: "https://cdn0.iconfinder.com/data/icons/logos-brands-in-colors/128/react-256.png", // (optional) default: undefined
      ...
      // actions: ["Sí", "No"], // (Android only) See the doc for notification actions to know more
      actions: ["ReplyInput"],
      reply_placeholder_text: "Escribe aquí...", // (required)
      reply_button_text: "Responder", // (required)
